...
function stag_create_post_type_portfolio() {
	$labels = array(
...
function stag_portfolio_build_taxonomies() {
...
add_action( 'init', 'stag_create_post_type_portfolio' );
add_action('init', 'stag_portfolio_build_taxonomies', 0);
